          ...
          <>
            ...
            <section id="security" className="py-32 bg-slate-50 relative border-t border-slate-200">
              <div className="max-w-7xl mx-auto px-6 text-center">
                <h3 className="text-sm font-bold text-brand-600 uppercase tracking-[0.4em] mb-4">Security first</h3>
                <h2 className="text-4xl lg:text-5xl font-bold text-slate-900 mb-8 tracking-tight">Enterprise-grade by default</h2>
            ...
            <section className="py-40 relative overflow-hidden bg-white">
              ...
              <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
                ...
                <div className="flex flex-wrap items-center justify-center gap-6">
                  <button className="px-12 py-5 bg-brand-600 hover:bg-brand-700 text-white rounded-full font-bold transition-all border border-brand-700 shadow-[inset_0_1px_0_rgba(255,255,255,0.2),0_1px_2px_rgba(0,0,0,0.05),0_30px_60px_-15px_rgba(21,112,239,0.3)] active:scale-95 flex items-center gap-3 group text-lg">
                    Schedule a Demo
