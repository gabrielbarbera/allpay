      ...
      <main className="flex-grow">
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <section id="security" className="py-32 bg-slate-50 relative border-t border-slate-200 overflow-hidden">
                  ...
                  <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
                   {[
                     ...
                     <motion.div
                       ...
                       className="p-10 rounded-3xl bg-white border border-slate-200 text-left group hover:border-brand-600/30 shadow-2xl transition-all duration-500"
                     >
            ...
            <section className="py-40 relative overflow-hidden bg-white">
              ...
              <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
                <motion.h2
                  ...
                  className="text-5xl lg:text-7xl font-bold text-slate-900 mb-10 tracking-tighter leading-[1.1]"
                >
